...
abstract class $ChatMessageCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userName, DateTime createdAt, String message});
}
...
class _$_ChatMessage implements _ChatMessage {
  _$_ChatMessage(
      {required this.userName, required this.createdAt, required this.message});
  ...
  @override
  String toString() {
    return 'ChatMessage(userName: $userName, createdAt: $createdAt, message: $message)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, userName, createdAt, message);
...
abstract class _ChatMessage implements ChatMessage {
  factory _ChatMessage(
      ...
      required final String message}) = _$_ChatMessage;
